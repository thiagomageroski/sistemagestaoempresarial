...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.produtos.checkout', compact('carrinho', 'subtotal', 'frete', 'desconto', 'total', 'user'));
    }
    ...
    public function aplicarCupom(Request $request)
    {
        ...
        // Aplicar desconto de R$ 50,00 para cupons válidos
        $desconto = 50.00;

        // Atualizar sessão com o desconto
    ...
    private function validarCupom($codigo)
    {
        ...
        $cuponsValidos = ['DESCONTO10', 'PROMO20', 'FRETEGRATIS', 'BLACKFRIDAY', 'SUPER10'];

        return in_array(strtoupper($codigo), $cuponsValidos);
    }
