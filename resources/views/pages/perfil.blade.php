...
<body class="min-h-screen flex flex-col">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-1/4">
                    <div class="glass-card rounded-2xl p-8 mb-8">
                        ...
                        <nav class="space-y-2">
                            <a href="#informacoes" class="nav-tab active flex items-center px-5 py-4 text-gray-700"
                                data-target="informacoes">
                                <i class="fas fa-user-circle nav-icon mr-4"></i>
                                <span class="font-medium">Informações Pessoais</span>
                            </a>
                            <a href="#seguranca" class="nav-tab flex items-center px-5 py-4 text-gray-700"
                                data-target="seguranca">
                                <i class="fas fa-lock nav-icon mr-4"></i>
                                <span class="font-medium">Segurança</span>
                            </a>
                            <a href="#preferencias" class="nav-tab flex items-center px-5 py-4 text-gray-700"
                                data-target="preferencias">
                ...
                <div class="w-full lg:w-3/4">
                        ...
                        <form action="{{ route('perfil.update') }}" method="POST" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="floating-label">
                                    <input type="text" name="nome" value="{{ $perfil['nome'] }}"
                                        class="input-field w-full px-5 py-4" placeholder=" " required>
                            ...
                            <div class="floating-label">
                                <input type="email" value="{{ $user['email'] }}" disabled
                                    class="input-field w-full px-5 py-4 bg-gray-50 cursor-not-allowed" placeholder=" ">
                            ...
                            <div class="action-buttons">
                                <button type="button"
                                    class="btn-secondary px-8 py-4 transition-all duration-300 flex items-center font-medium"
                                    onclick="resetForm('informacoes')">
                                    <i class="fas fa-times mr-3"></i> Cancelar
                                </button>
                                <button type="submit"
                                    class="btn-primary px-8 py-4 text-white flex items-center font-medium">
                    ...
                    <div id="seguranca" class="secao glass-card rounded-2xl p-10 mb-8">
                        ...
                        <form action="{{ route('perfil.update-password') }}" method="POST" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="floating-label">
                                    <input type="password" name="senha_atual" class="input-field w-full px-5 py-4"
                                        placeholder=" " required>
                                    <label for="senha_atual">Senha Atual</label>
                                </div>
                                <div class="floating-label">
                                    <input type="password" name="nova_senha" class="input-field w-full px-5 py-4"
                                        placeholder=" " required>
                    ...
                    <div id="preferencias" class="secao glass-card rounded-2xl p-10 mb-8">
                        ...
                        <form action="{{ route('perfil.update') }}" method="POST">
                                ...
                                <div class="preference-item p-6 rounded-xl">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-gray-600 mt-2">Receba ofertas exclusivas, novidades e
                                                descontos especiais diretamente no seu e-mail</p>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            ...
                                            <div
                                                class="w-14 h-7 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-7 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-primary">
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="preference-item p-6 rounded-xl">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-gray-600 mt-2">Receba alertas importantes sobre seus pedidos
                                                e promoções via SMS</p>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" name="notificacao_sms" value="1" class="sr-only peer"
                                                {{ $perfil['preferencias']['notificacao_sms'] ? 'checked' : '' }}>
                                            <div
                                                class="w-14 h-7 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-7 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all peer-checked:bg-primary">
                                            </div>
                                        </label>
                                ...
                                <div class="preference-item p-6 rounded-xl">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-gray-600 mt-2">Permita notificações no navegador para
                                                acompanhar seus pedidos em tempo real</p>
                                        </div>
                                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="action-buttons">
                                <button type="button"
                                    class="btn-secondary px-8 py-4 transition-all duration-300 flex items-center font-medium"
                                    onclick="resetForm('preferencias')">
                                    <i class="fas fa-times mr-3"></i> Cancelar
                                </button>
                                <button type="submit"
                                    class="btn-primary px-8 py-4 text-white flex items-center font-medium">
                    ...
                    <div id="enderecos" class="secao glass-card rounded-2xl p-10 mb-8">
                        <div class="section-header">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <button class="btn-primary px-6 py-3 text-white flex items-center font-medium"
                        ...
                        <div id="form-endereco"
                            class="hidden mt-8 p-8 border-2 border-dashed border-primary border-opacity-20 rounded-2xl glass-card">
                            <h3 class="font-bold text-2xl text-gray-800 mb-6 flex items-center"
                                id="titulo-form-endereco">
                            ...
                            <form id="endereco-form" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="floating-label">
                                        <input type="text" id="endereco-cep" name="cep"
                                            class="input-field w-full px-4 py-3" placeholder=" " required>
                                        <label for="endereco-cep">CEP</label>
                                    </div>
                                    <div class="floating-label">
                                        <input type="text" id="endereco-apelido" name="apelido"
                                            class="input-field w-full px-4 py-3" placeholder=" " required>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="floating-label">
                                        <input type="text" id="endereco-estado" name="estado"
                                            class="input-field w-full px-4 py-3" placeholder=" " required>
                                ...
                                <div class="flex items-center p-4 bg-blue-50 rounded-xl">
                                    <input type="checkbox" id="endereco-principal" name="principal"
                                        class="mr-3 w-5 h-5 text-primary">
                                    <label for="endereco-principal" class="text-gray-700 font-medium">Definir como
                                        endereço principal</label>
                                </div>

                                <div class="flex justify-end space-x-4 pt-4">
                                    <button type="button" class="btn-secondary px-6 py-3 font-medium"
                    ...
                    <div id="pagamentos" class="secao glass-card rounded-2xl p-10">
                        ...
                        <div id="form-cartao"
                            ...
                            <form id="cartao-form" class="space-y-6">
                                ...
                                <div class="floating-label">
                                    <input type="text" id="cartao-numero" name="numero"
                                        class="input-field w-full px-4 py-3" placeholder=" " required>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="floating-label">
                                        <input type="text" id="cartao-titular" name="titular"
                                            class="input-field w-full px-4 py-3" placeholder=" " required>
                                        <label for="cartao-titular">Nome do Titular</label>
                                    </div>
                                    <div class="floating-label">
                                        <input type="text" id="cartao-validade" name="validade"
                                            class="input-field w-full px-4 py-3" placeholder=" " required>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="floating-label">
                                        <input type="text" id="cartao-cvv" name="cvv"
                                            class="input-field w-full px-4 py-3" placeholder=" " required>
                                        <label for="cartao-cvv">CVV</label>
                                    </div>
                                    <div class="floating-label">
                                        <input type="text" id="cartao-apelido" name="apelido"
                                            class="input-field w-full px-4 py-3" placeholder=" " required>
                                ...
                                <div class="flex items-center p-4 bg-blue-50 rounded-xl">
                                    <input type="checkbox" id="cartao-principal" name="principal"
                                        class="mr-3 w-5 h-5 text-primary">
                                    <label for="cartao-principal" class="text-gray-700 font-medium">Definir como cartão
                                        principal</label>
                                </div>
    ...
    <script>
        ...
        const cityInput = document.getElementById('endereco-cidade');
        const stateInput = document.getElementById('endereco-estado');
        let enderecos = [];
        ...
        function mostrarToast(mensagem, tipo = 'success') {
            ...
            toast.className = `fixed top-6 right-6 z-50 px-6 py-4 rounded-xl flex items-center shadow-lg transform transition-all duration-300 ${tipo === 'success' ? 'success-message' : 'error-message'
                }`;
            toast.style.transform = 'translateX(100%)';

            toast.innerHTML = `
                <i class="fas ${tipo === 'success' ? 'fa-check-circle' : 'fa-exclamation-circle'} text-2xl mr-3 ${tipo === 'success' ? 'text-green-600' : 'text-red-600'
                }"></i>
                <div>
